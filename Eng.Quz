 ...
 */
    ...
    $.dlxQuiz = function ( element, options ) {
      var plugin = this,
        ...
        quizScoreRank_text: {
          a: "Your mark is [A], Perfect, Outstanding!",
          b: "Your mark is [B], You did well, Very commendable!",
          c: "Your mark is [C], Quite satisfactory.",
          d: "Your mark is [D], Requires significant improvement.",
          f: "Your mark is [E], Did you even try? Considerable effort is needed."
        },
